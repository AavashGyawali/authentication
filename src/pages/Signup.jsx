...
const Signup = () => {
  ...
  const { signup, error } = userAuthStore();
  ...
  return (
    ...
    >
      <div className=" flex flex-col justify-center items-center gap-6 px-6 py-6 rounded-t-md mx-4">
        <h1 className="text-2xl text-green-400  font-bold">Create Account</h1>
        ...
        <form onSubmit={handleSignUp} className="flex flex-col gap-4">
          ...
          <Button text="signup" buttonColor="green-500" textColor="white" />
        </form>
      </div>
